            ...
            <div className="container flex flex-col md:flex-row items-center justify-around gap-12 px-6 py-16 pb-30 md:pb-40">
                ...
                >
                    <a 
                        ...
                        className="inline-flex items-center justify-center gap-3 bg-slate-800/90 hover:bg-slate-700/90 border border-slate-600 hover:border-slate-500 text-white px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
                    >
                        {/* WhatsApp Icon */}
