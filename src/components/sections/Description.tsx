            ...
            <div className="container flex flex-col md:flex-row items-center justify-around gap-12 px-6 md:pb-16 py-16">
                ...
                >
                    ...
                    >
                        ...
                        <div className="">
                            <div className="flex flex-col md:flex-row items-left justify-start md:justify-start md:items-left space-x-2 mb-0">
                                <p className="text-base md:text-lg text-gray-300 leading-8">
                                    Dengan tagline
                                </p>
                                <p className="text-base font-bold md:text-lg bg-gradient-to-r from-[#F9F9FF] to-[#7E79FF] bg-clip-text text-transparent transition-colors duration-200 leading-8">
                                    #BuatTeknologiDiBawahSatuJuta, 
                                </p>
                            </div>
                            <p className="text-base md:text-lg text-gray-300 leading-8">
                                kami bukan hanya menawarkan jasa, kami juga menawarkan kesempatan. Kesempatan buat setiap mahasiswa dan perintis untuk bersaing dan menang. Gasss wujudkan ide kamu bareng kami!
                            </p>
                        </div>
                ...
                <div className="w-full md:w-1/2 relative flex items-center justify-center h-96">
                    ...
                    <motion.div
                        ...
                        transition={{ 
                            opacity: { duration: 1.8, repeat: Infinity, ease: "easeInOut", delay: 1 },
